...
### 🔹 [Projeto 1 – Around (Rede Social de Imagens)](https://github.com/ArthurBarbo/web_project_api_full)  
...
- Postagem de imagens
- Curtidas e remoção de conteúdo
- Interface moderna seguindo boas práticas de UX
