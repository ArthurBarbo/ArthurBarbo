...
- [Projeto 1](https://github.com/ArthurBarbo/web_project_api_full) –
- 🌍 Around — Rede Social de Imagens
...
- [Projeto 2](https://github.com/ArthurBarbo/PowerSpot) –
...
O sistema visa fornecer informações detalhadas sobre veículos elétricos, incluindo localização, especificações e dados em tempo real, com foco em usabilidade e integração inteligente de APIs.
